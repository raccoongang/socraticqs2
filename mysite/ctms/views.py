...
# class CreateSharedCourseView(NewLoginRequiredMixin, CourseCoursletUnitMixin, CreateView):
#     model = SharedCourse
#     form_class = CreateSharedCourseForm
#     def get_success_url(self):
#         return reverse('ctms:shared_courses')
#
#     def get_form_kwargs(self):
#         kwargs = super(CreateSharedCourseView, self).get_form_kwargs()
...
#         return super(CreateSharedCourseView, self).form_valid(form)
#
